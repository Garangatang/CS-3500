...
namespace SpreadsheetTests
{
    ...
    public class UnitTest1
    {
        ...
        [TestMethod]
        public void SavingDictionaryToFile()
        {
            AbstractSpreadsheet testSheet = new Spreadsheet();
            testSheet.SetContentsOfCell("A1", ("=3 + 4"));
            testSheet.SetContentsOfCell("B3", ("=A1 + 3"));
            testSheet.SetContentsOfCell("C1", ("=B3 + 2"));
            testSheet.SetContentsOfCell("D4", ("=C1 + 5"));
            testSheet.Save("test.xml");
        }

        [TestMethod]
        public void ReadFileToDictionary()
        {
            AbstractSpreadsheet testSheet = new Spreadsheet("test.xml", s => true, s => s.ToUpper(), "new");
            Assert.AreEqual(new Formula("A1 + 3"), testSheet.GetCellContents("B3"));
            Assert.AreEqual(new Formula("C1 + 5"),  testSheet.GetCellContents("D4"));
        }
        [TestMethod]
        public void SavingDictionaryToFile2()
        {
            AbstractSpreadsheet testSheet = new Spreadsheet();
            testSheet.SetContentsOfCell("A1", ("=3 + 4"));
            testSheet.SetContentsOfCell("B3", ("=A1 + 3"));
        ...
        {
            AbstractSpreadsheet testSheet = new Spreadsheet();
            string getVersion = testSheet.GetSavedVersion("test2.xml");
            Assert.AreEqual(new Formula("A1 + 3"), testSheet.GetCellContents("B3"));
            Assert.AreEqual(new Formula("C1 + 5"), testSheet.GetCellContents("D4"));
        }

        [TestMethod]
        public void AddingNumbersToSpreadSheet()
        {
            Spreadsheet testSheet = new Spreadsheet();
            testSheet.SetContentsOfCell("A1", "35.0");
            Assert.AreEqual(35.0, testSheet.GetCellContents("A1"));
        }
        [TestMethod]
        [ExpectedException(typeof(InvalidNameException))]
        public void AddingNumbersInvalidName()
        {
            Spreadsheet testSheet = new Spreadsheet();
            testSheet.SetContentsOfCell("$", "24.0");
        }
        [TestMethod]
        public void RewriteDoubleInCell()
        {
            Spreadsheet testSheet = new Spreadsheet();
            testSheet.SetContentsOfCell("A1", "35.0");
            Assert.AreEqual(35.0, testSheet.GetCellContents("A1"));
            testSheet.SetContentsOfCell("A1", "23.0");
            Assert.AreEqual(23.0, testSheet.GetCellContents("A1"));
        }
        [TestMethod]
        public void AddingStringsToSpreadsheet()
        {
            Spreadsheet testSheet = new Spreadsheet();
            testSheet.SetContentsOfCell("B4", "I am a clown.");
            Assert.AreEqual("I am a clown.", testSheet.GetCellContents("B4"));
        }
        
        [TestMethod]
        [ExpectedException(typeof(InvalidNameException))]
        public void InvalidNameForCellTypeString()
        {
            Spreadsheet testSheet = new Spreadsheet();
            testSheet.SetContentsOfCell("#", "I am sure I am a clown");
        }
        [TestMethod]
        public void OverwritingCellTypeString()
        {
            Spreadsheet testSheet = new Spreadsheet();
            testSheet.SetContentsOfCell("A6", "Monkey");
            Assert.AreEqual("Monkey", testSheet.GetCellContents("A6"));
            testSheet.SetContentsOfCell("A6", "Elephant");
            Assert.AreEqual("Elephant", testSheet.GetCellContents("A6"));
        }

        [TestMethod]
        public void AddingEquationToSpreadSheet()
        {
            AbstractSpreadsheet testSheet = new Spreadsheet();
            testSheet.SetContentsOfCell("A1","=4 + 3");
            Assert.AreEqual(new Formula("4 + 3"), testSheet.GetCellContents("A1"));
        }
        
        [TestMethod]
        public void AddingEquationWithDependencies()
        {
            AbstractSpreadsheet testSheet = new Spreadsheet();
            testSheet.SetContentsOfCell("A1", "=3 + 4");
            testSheet.SetContentsOfCell("B3", "=A1 + 3");
            ...
            expected.Add("A1");
            expected.Add("B3");
            List<string> resultList = (List<string>)testSheet.SetContentsOfCell("A1", "=5 + 2");
            //List<string> resultList = (List<string>) testSheet.SetCellContents("A1", new Formula("4 + 3")); ;
        ...
        public void CircularDependencyErrorAfterResetEquation()
        {
            AbstractSpreadsheet testSheet = new Spreadsheet();
            testSheet.SetContentsOfCell("A1", "=3 + 4");
            testSheet.SetContentsOfCell("B3", "=A1 + 3");
            testSheet.SetContentsOfCell("A1", "=B3 + 4");
        }
        [TestMethod]
        [ExpectedException(typeof(CircularException))]
        public void CircularDependencyImmediatelyBetween2Equations()
        {
            AbstractSpreadsheet testSheet = new Spreadsheet();
            testSheet.SetContentsOfCell("A1", "=B3 + 4");
            testSheet.SetContentsOfCell("B3", "=A1 + 3");
        ...
        public void SolvingEquation()
        {
            ...
            testSheet.SetContentsOfCell("C1", ("=B3 + 2"));
            testSheet.SetContentsOfCell("D4", ("=C1 + 5"));
            Assert.AreEqual((double)7, testSheet.GetCellValue("A1"));
        }

        [TestMethod]
        [ExpectedException(typeof(CircularException))]
        public void CircularDependencySeveralLevelsDown()
        {
            AbstractSpreadsheet testSheet = new Spreadsheet();
            testSheet.SetContentsOfCell("A1", ("=3 + 4"));
            testSheet.SetContentsOfCell("B3", ("=A1 + 3"));
            testSheet.SetContentsOfCell("C1", ("=B3 + 2"));
            testSheet.SetContentsOfCell("D4", ("=C1 + 5"));
            testSheet.SetContentsOfCell("A1", ("=D4 + 10"));
        }

        [TestMethod]
        public void ReturningListOfDependeesFromCellResetToNumber()
        {
            AbstractSpreadsheet testSheet = new Spreadsheet();
            testSheet.SetContentsOfCell("A1", ("=3 + 4"));
            testSheet.SetContentsOfCell("B3", ("=A1 + 3"));
            testSheet.SetContentsOfCell("C1", ("=A1 + 2"));
            testSheet.SetContentsOfCell("D4", ("=A1 + 5"));
            List<string> expected = new List<string>();
            expected.Add("A1");
            expected.Add("B3");
            expected.Add("C1");
            expected.Add("D4");
            List<string> resultList = (List<string>)testSheet.SetContentsOfCell("A1", "6");
            CollectionAssert.AreEquivalent(expected, resultList);
        }
        [TestMethod]
        public void ReturningListOfDependeesFromCellResetToString()
        {
            AbstractSpreadsheet testSheet = new Spreadsheet();
            testSheet.SetContentsOfCell("A1", ("=3 + 4"));
            testSheet.SetContentsOfCell("B3", ("=A1 + 3"));
            ...
            expected.Add("C1");
            expected.Add("D4");
            List<string> resultList = (List<string>)testSheet.SetContentsOfCell("A1", "reset");
            CollectionAssert.AreEquivalent(expected, resultList);
        }

        [TestMethod]
        public void ReturnListOfNonemptyCells()
        {
            AbstractSpreadsheet testSheet = new Spreadsheet();
            testSheet.SetContentsOfCell("A1", ("=3 + 4"));
            testSheet.SetContentsOfCell("B3", ("=A1 + 3"));
            ...
            expected.Add("C1");
            expected.Add("D4");
            //IEnumerable<string> returnList = testSheet.GetNamesOfAllNonemptyCells();
            //List<string> convertedList = returnList.ToList();
            CollectionAssert.AreEquivalent(expected, testSheet.GetNamesOfAllNonemptyCells().ToList());
        }
