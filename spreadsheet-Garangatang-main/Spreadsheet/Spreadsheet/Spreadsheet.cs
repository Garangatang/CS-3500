...
namespace SS
{
    public class Spreadsheet : AbstractSpreadsheet
    {
        ...
        public override object GetCellContents(string name)
        {
            ...
            return spreadSheetDict[normName].CellContents();
        }
        ...
        protected override IList<string> SetCellContents(string name, Formula formula)
        {
            ...
            if (spreadSheetDict.ContainsKey(name))
            {
                ...
                catch
                {
                    ...
                    spreadSheetDict[name] = new Cell(new FormulaError("Cannot evaluate equation."));
                }
            }
            if (!spreadSheetDict.ContainsKey(name))
            {
        ...
        {
            List<string> cellsNeededToRecalc = GetCellsToRecalculate(var).ToList();
